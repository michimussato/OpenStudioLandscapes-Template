<!-- TOC -->
* [OpenStudioLandscapes-Template](#openstudiolandscapes-template)
<!-- TOC -->
...
Instead of the [`definitions.py`](src/OpenStudioLandscapes/Template/definitions.py), 
the accompanying [`workspace.yaml`](workspace.yaml) loads 
the [`_definitions_with_upstream_specs.py`](src/OpenStudioLandscapes/Template/_definitions_with_upstream_specs.py) 
which also contains 
